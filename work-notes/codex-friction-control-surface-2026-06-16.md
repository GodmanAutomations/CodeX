...
- `/Users/stephengodman/CodeX/QUICKSTART.md`

Behavior:

- `/Users/stephengodman/CodeX/bin/codex-launch` now opens the Codex desktop app through `/Users/stephengodman/bin/codex-app-op`.
...
- `/Users/stephengodman/CodeX/bin/codex-ensure-standalone` now treats app-only mode as normal and skips CLI-only MCP checks unless `CODEX_ALLOW_CLI_PREFLIGHT=1` is set.

Backups:

- `/Users/stephengodman/CodeX/backups/app-only-codex-20260616-0238/`

## New Commands

- `/Users/stephengodman/CodeX/bin/codex-status`
- `/Users/stephengodman/CodeX/bin/codex-mcp`
- `/Users/stephengodman/CodeX/bin/codex-receipts-index`
...
- Writes `/Users/stephengodman/CodeX/work-notes/INDEX.md`.
...
- `codex-receipts-index --limit 120` wrote `/Users/stephengodman/CodeX/work-notes/INDEX.md`.
