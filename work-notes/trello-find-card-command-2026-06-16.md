...
- `/Users/stephengodman/CodeX/bin/trello-find-card`
...
```bash
/Users/stephengodman/CodeX/mcp_servers/trello_mcp_launcher.sh --search-cards --query Byrd --limit-cards 5
```
...
```bash
/Users/stephengodman/CodeX/bin/trello-find-card Byrd
```

Find on another configured board:

```bash
/Users/stephengodman/CodeX/bin/trello-find-card --board artesian Byrd
```

Raw JSON:

```bash
/Users/stephengodman/CodeX/bin/trello-find-card --json Byrd
```
...
- `chmod 755 /Users/stephengodman/CodeX/bin/trello-find-card`
- `/Users/stephengodman/000_AI/bin/python3 -m py_compile /Users/stephengodman/CodeX/bin/trello-find-card /Users/stephengodman/CodeX/mcp_servers/trello_mcp_server.py`
- `bash -n /Users/stephengodman/CodeX/mcp_servers/trello_mcp_launcher.sh`
