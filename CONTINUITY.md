...
This file is the map. The lanes below are separate on purpose.
...
- `one-true-sentence.txt`
- `one-true-sentence.timestamp`
- `codex_continuity.py`
...
Current files and live checks beat memory. Keep startup pulse, practical memory, vault continuity, and private journal distinct.
